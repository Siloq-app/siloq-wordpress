<?php
/**
 * Siloq Bricks Builder Panel
 *
 * Injects the shared Siloq floating panel when the Bricks visual builder
 * is active (bricks_is_builder() returns true).
 *
...
class Siloq_Bricks_Panel {
    ...
    /**
     * Enqueue shared floating panel assets inside the Bricks builder context.
     */
    public static function enqueue_assets() {
        if ( ! self::_is_bricks_builder() ) {
            return;
        }
    ...
    private static function _is_bricks_builder() {
