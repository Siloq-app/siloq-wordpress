...
class Siloq_Yoast_Integration {
	...
	public static function maybe_register_hooks() {
		if ( ! self::yoast_active() ) { return; }
		add_filter( 'wpseo_exclude_from_sitemap_by_post_ids', array( __CLASS__, 'exclude_redirected_posts' ) );
	}
	...
	private static function yoast_active() { return defined( 'WPSEO_VERSION' ); }
}
